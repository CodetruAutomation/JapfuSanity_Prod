...
import com.Japfu.utils.ReportUtils;
...
public final class FrameworkConstants {
    ...
    public static final String WINDOWS_LOCAL_AND_US = PropertiesHelpers.getValue("windows_Local_US");
    public static final String LINUX_IN = PropertiesHelpers.getValue("linuxIN");
    ...
    public static final String RECIPIENT_EMAIL1 = PropertiesHelpers.getValue("Recipient_Email1");
    public static final String RECIPIENT_EMAIL2 = PropertiesHelpers.getValue("Recipient_Email2");
    public static final String RECIPIENT_EMAIL3 = PropertiesHelpers.getValue("Recipient_Email3");
    public static final String RECIPIENT_EMAIL4 = PropertiesHelpers.getValue("Recipient_Email4");
    ...
    public static final String CONSULTANT_USERNAME = PropertiesHelpers.getValue("CONSULTANT_USERNAME");
    public static final String CONSULTANT_PASSWORD = PropertiesHelpers.getValue("CONSULTANT_PASSWORD");
    public static final String CONTRACTOR_USERNAME = PropertiesHelpers.getValue("CONTRACTOR_USERNAME");
    public static final String CONTRACTOR_PASSWORD = PropertiesHelpers.getValue("CONTRACTOR_PASSWORD");
